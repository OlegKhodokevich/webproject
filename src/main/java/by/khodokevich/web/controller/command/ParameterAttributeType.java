...
public final class ParameterAttributeType {
    ...
    public static final String EXECUTOR_LIST = "executorList";
    ...
    public static final String SPECIALIZATION_MAP = "specializationMap";
    public static final String STATUS_LIST = "statusList";

    public static final String STATUS_COMMAND = "statusCommand";
    public static final String INDEX = "index";
    public static final String SET_ARCHIVE_USERS = "archivedUserSet";
