...
public class ContractDaoImpl extends AbstractDao<Contract> implements ContractDao {
    ...
    private static final String SQL_SELECT_ALL_OFFER_BY_ID_EXECUTOR = "SELECT IdContract, orders.IdOrder, IdUserExecutor, Conclude, Complete FROM contracts JOIN users ON users.IdUser = contracts.IdUserExecutor WHERE contracts.IdUserExecutor = ?;";
